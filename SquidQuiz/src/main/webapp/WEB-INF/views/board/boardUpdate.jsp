...
<body>
	...
	<form action="boardUpdate.ptsd" method="post" enctype="multipart/form-data" align="center">
		...
		<div >
			...
			<div class="btn btn-primary">
				<input type="submit" value="수정" href='boardDetail.ptsd${board.bNo }'" class="btn btn-primary">
				<input type="button" value=" 취소" onclick="history.back(-1);" class="btn btn-primary">
			</div>
		</form>
	</div>
