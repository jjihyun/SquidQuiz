	...
	<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
	  <div class="modal-dialog modal-sm">
	    ...
	    <div class="modal-body">
	    	제 1 조 (목적)<br>
			본 이용약관(이하 "약관")은 이용고객(이하 "회원")이 오징어게임 기부 서비스(이하 "오징어게임")를 이용함에 있어 오징어게임과 회원 간의 권리, 의무, 책임 사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
			<br>
			제 2 조 (정의)<br>
			본 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br>
			
			1. "1365기부포털"이라 함은 기부금품 모집등록 등 기부금품 관련 민원사무 또는 기부금품 관련 정보를 이용할 수 있는 사이트 전체를 말합니다.<br>
			2. "회원"이라 함은 본 약관에 동의하고 서비스를 이용하는 이용자를 말합니다.<br>
			3. "이용계약"이라 함은 본 약관을 포함하여 서비스 이용과 관련하여 1365기부포털 회원 간에 체결하는 모든 계약을 말합니다.<br>
			4. "ID(이하 "아이디")"라 함은 회원의 식별 및 서비스 이용을 위하여 회원의 신청에 따라 1365기부포털이 회원별로 부여하는 문자와 숫자의 고유한 조합을 말합니다.<br>
			...
			1. 1365기부포털은 귀하가 본 약관의 내용에 동의하는 것을 조건으로 서비스를 제공할 것이며, 귀하가 본 약관의 내용에 동의하는 경우 1365기부포털의 서비스 제공 행위 및 귀하의 서비스 사용 행위는 본 약관이 우선하여 적용됩니다.<br>
			2. 1365기부포털은 관련 법령에 위배되지 않는 범위 안에서 본 약관을 개정할 수 있습니다. 개정된 약관은 정당한 절차에 따라 1365기부포털을 통해 공지됨으로써 효력이 발휘됩니다. 회원은 정기적으로 1365기부포털을 방문하여 약관의 변경사항을 확인하여야 합니다. 변경된 약관에 대한 정보를 알지 못해 발생하는 회원의 피해는 1365기부포털에서 책임지지 않습니다.<br>
			3. 회원은 변경된 약관에 동의하지 않을 경우 회원 탈퇴(해지)를 요청할 수 있습니다.<br>
			제 4 조 (약관 외 준칙)
			<br>
			1. 1365기부포털은 필요한 경우 서비스 내의 개별항목에 대하여 개별약관 또는 운영원칙(이하 "서비스별 안내")을 정할 수 있습니다.<br>
